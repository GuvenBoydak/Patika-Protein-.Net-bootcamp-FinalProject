...
{
    public class AppUserRegisterOptionalDtoValidator : AbstractValidator<AppUserRegisterOptionalDto>
    {
        public AppUserRegisterOptionalDtoValidator()
        {
            ...
            RuleFor(x => x.DateOfBirth).NotEmpty().WithMessage("Doğum günü boş geçilemez.").Must(x => x.Value.Year > 1900).WithMessage("Doğum tarihini 1900'dan büyük giriniz.").Must(x => x.Value.Year < 2015).WithMessage("Doğum tarihini 2015'dan Küçük giriniz.");
        }
    }
}
